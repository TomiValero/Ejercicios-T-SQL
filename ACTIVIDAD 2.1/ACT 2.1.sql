...
--  12 Listado con nombre, duración y número de todas las clases de los cursos con ID 2, 5 y 7. Ordenados por ID de Curso ascendente y
--   luego por número de clase ascendente.
...
-- FROM Cursos 
-- WHERE MONTH(FechaEstreno) <=6  AND YEAR(FechaEstreno) = 2019
